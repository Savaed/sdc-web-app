...
{
    public interface IGeneralSightseeingInfoDbService : IServiceBase
    {
        /// <summary>
        ...
        Task<IEnumerable<GeneralSightseeingInfo>> GetByAsync(Expression<Func<GeneralSightseeingInfo, bool>> predicate);
        ...
        /// <exception cref="InternalDbServiceException">The resource does not exist or has a null value or any
        /// other problems with retrieving data from database occurred.</exception>
        Task<IEnumerable<GeneralSightseeingInfo>> GetWithPaginationAsync(int pageNumber = 1, int pageSize = 30);
