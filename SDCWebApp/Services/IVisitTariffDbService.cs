...
{
    public interface IVisitTariffDbService : IServiceBase
    {
        /// <summary>
        /// Asynchronously retrievs <see cref="VisitTariff"/> entity with given <paramref name="id"/> from the database. 
        ...
        Task<VisitTariff> GetAsync(string id);
        ...
        /// <exception cref="InternalDbServiceException">The resource does not exist or has a null value or any
        /// other problems with retrieving data from database occurred.</exception>
        Task<IEnumerable<VisitTariff>> GetAllAsync();
        ...
        /// <exception cref="InternalDbServiceException">The resource does not exist or has a null value or any
        /// other problems with retrieving data from database occurred.</exception>
        Task<IEnumerable<VisitTariff>> GetWithPaginationAsync(int pageNumber = 1, int pageSize = 30);
        ...
        /// <exception cref="InternalDbServiceException">The resource does not exist or has a null value or any
        /// other problems with retrieving data from database occurred.</exception>
        Task<VisitTariff> UpdateAsync(VisitTariff tariff);
        ...
        /// <exception cref="InternalDbServiceException">The resource does not exist or has a null value or any
        /// other problems with retrieving data from database occurred.</exception>
        Task<VisitTariff> RestrictedUpdateAsync(VisitTariff tariff);
        ...
        /// <exception cref="InternalDbServiceException">The table with <see cref="VisitTariff"/> entities does not exist or it is null or 
        /// cannot save properly any changes made by add operation.</exception>
        Task<VisitTariff> AddAsync(VisitTariff tariff);
        ...
        /// <exception cref="InternalDbServiceException">The table with <see cref="VisitTariff"/> entities does not exist or it is null or 
        /// cannot save properly any changes made by add operation.</exception>
        Task<VisitTariff> RestrictedAddAsync(VisitTariff tariff);

        /// <summary>
        /// Filters set of data of type <see cref="VisitTariff"/>. Returns filterd data set. Throws an exception if <paramref name="predicate"/> is null, 
        ...
        /// <exception cref="InternalDbServiceException">The resource does not exist or has a null value or any
        /// other problems with retrieving data from database occurred.</exception>        
        Task<IEnumerable<VisitTariff>> GetByAsync(Expression<Func<VisitTariff, bool>> predicate);
    }
}
