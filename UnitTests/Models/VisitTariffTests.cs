...
namespace UnitTests.Models
{
    ...
    public class VisitTariffTests
    {
        ...
        {
            var sightseeingTariff1 = new VisitTariff { Id = "1", Name = "test" };
            var sightseeingTariff2 = new VisitTariff { Id = "1", Name = "test" };
        ...
        {
            var sightseeingTariff1 = new VisitTariff { Id = "1", Name = "test" };
            var sightseeingTariff2 = new VisitTariff { Id = "1", Name = "other test" };
