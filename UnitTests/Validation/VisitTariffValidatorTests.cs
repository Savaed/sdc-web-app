...
{
    public class VisitTariffValidatorTests
    {
        private readonly VisitTariffValidator _validator = new VisitTariffValidator();


        [Test]
        public void Validate__Name_is_null_or_empty__Should_be_invalid([Values(null, "")] string name)
        {
            var invalidTariff = new VisitTariff { Name = name };
        ...
        {
            var invalidTariff = new VisitTariff { Name = "123456789012345678901234567890123456789012345678901" };
        ...
        {
            var validTariff = new VisitTariff { Name = "12345678901234567890123456789012345678901234567890" };
        ...
        {
            var validTariff = new VisitTariff { Name = "1234567890123456789012345678901234567890123456789" };
